...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
  /* Name,            Address,     Length,     HobOption, ResourceType, ResourceAttribute,   MemoryType, CacheAttributes */
  ...
  /* --------------------- Other (NoHob/AddDev memory-like) --------------------- */
  ...
  { "UFS2 UFS REGS",   0x01D90000, 0x00020000, AddDev, MMAP_IO, UNCACHEABLE,  MmIO,   NS_DEVICE }, 
  ...
  { "TLMM_EAST",       0x03100000, 0x00300000, AddDev, MMAP_IO, UNCACHEABLE,  MmIO,   NS_DEVICE },                      
  ...
  { "PDC_DISPLAY",     0x0B270000, 0x00010000, AddDev, MMAP_IO, UNCACHEABLE,  MmIO,   NS_DEVICE },                      
  { "PDC_DISP_SEQ",    0x0B470000, 0x00010000, AddDev, MMAP_IO, UNCACHEABLE,  MmIO,   NS_DEVICE },                      
